...
{
    internal abstract class FakeClient : IRestClient
    {
        ...
        public abstract Task<IRestResponse> ExecuteAsync(IRestRequest request, Method httpMethod, CancellationToken cancellationToken = default);
