...
namespace VerboseRestSharp
{
    public interface IVerboseRestClient
    {
        ...
        /// </summary>
        Task<string> ExecuteAndGetStringAsync(IRestRequest request, CancellationToken token = default);
        ...
        /// </summary>
        Task<byte[]> ExecuteAndGetRawBytesAsync(IRestRequest request, CancellationToken token = default);
    }
}
