...
namespace VerboseRestSharp
{
    public interface IVerboseRestClient
    {
        ...
        /// </summary>
        Task<string> ExecuteAndGetStringResponseAsync(IRestRequest request, CancellationToken token = default);
        ...
        /// </summary>
        Task<byte[]> ExecuteAndGetRawBytesResponseAsync(IRestRequest request, CancellationToken token = default);
    }
}
